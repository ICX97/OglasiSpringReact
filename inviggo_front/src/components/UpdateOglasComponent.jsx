...
class UpdateOglasComponent extends Component {
    constructor(props){
        super(props)
        this.state = {
                ...
                <div className= "container">
                    <div className="row">
                        <div className="card col-md-6 offset-md-3 offset-md-3">
                            <h3 className="text-center">Edit Oglas</h3>
                            <div className="card-body">
                                <form>
                                    ...
                                    <div className="form-group">
                                        ...
                                        value={this.state.brTelcenaefona} onChange={this.changeCenaHandler}/>
                                    </div>
                                    ...
                                    <button className="btn btn-success" onClick={this.editOglas}>Save</button>
